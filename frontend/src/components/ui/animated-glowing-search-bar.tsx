...
const AnimatedGlowingSearchBar = ({
  ...
  return (
    <div className={`relative flex items-center ${className}`}>
      ...
      <div id="poda" className="relative flex items-center w-full group">
        <div
          className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] rounded-xl blur-[3px]
        ...
        ></div>
        <div
          className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] rounded-xl blur-[3px]
        ...
        <div
          className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] rounded-lg blur-[2px]
        ...
        <div
          className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] rounded-xl blur-[0.5px]
