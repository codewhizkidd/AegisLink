              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <h1 className="mt-8 max-w-4xl mx-auto text-balance text-6xl md:text-7xl lg:mt-16 xl:text-[5.25rem]">
                    Know if a link is safe before you click it
                  </h1>
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                    ASTRO analyzes links in real time using heuristics and
                    a trained ML classifier, then gives you a risk score with
                ...
                >
                  <div className="bg-foreground/10 rounded-[14px] border p-0.5">
                    <Button
                      ...
                      onClick={onScanClick}
                    >
                      <span className="text-nowrap">Scan a URL</span>
                    </Button>
                  </div>
                  <Button
                    size="lg"
                    ...
                    render={
                      <Link href="https://github.com/afraa786/CyberThreat" target="_blank" />
                    }
                  >
